...
import { Shield, Mail, Lock, User, Phone, Building, Eye, EyeOff } from 'lucide-react';
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <CardTitle className="text-2xl font-bold">Tourist Safety Portal</CardTitle>
          </div>
          <CardDescription>
            {t('auth.description', { defaultValue: 'Secure access to your safety dashboard' })}
          </CardDescription>
        </CardHeader>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="tourist">{t('auth.tourist')}</SelectItem>
                        <SelectItem value="authority">{t('auth.authority')}</SelectItem>
                        <SelectItem value="admin">{t('auth.admin')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  
                  {(signUpData.role === 'authority' || signUpData.role === 'admin') && (
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10"
                          required={signUpData.role === 'authority' || signUpData.role === 'admin'}
                        />
                      </div>
                    </div>
                  )}
                  ...
                  {signUpData.password !== signUpData.confirmPassword && signUpData.confirmPassword && (
                    <p className="text-sm text-destructive">{t('auth.passwords_dont_match')}</p>
                  )}
